...
import { Box, Heading, Text, Spinner, VStack, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Image } from '@chakra-ui/react';
      ...
      <ModalContent>
        ...
        <ModalBody>
          <VStack spacing={2} align="center">
            {profile ? (
              <>
                <Image src={profile.picture} alt="Profile Picture" boxSize="150px" borderRadius="full" />
                <Box p={5}>
