  ...
  const [dataBase, setDb] = useState([])
    ...
    return (
      <Row>
        <Col>
          <Card>
            <CardTitle tag="h5" className="border-bottom p-3 mb-0" style={{color: "#fde24b", fontFamily: 'system-ui'}}>
              <i className="bi bi-bell me-2"> </i>
              Personal Information
            </CardTitle>
            <CardBody>
              <Row>
              <Col  style={{ color: "rgb(99,100,102)", fontFamily: 'system-ui', borderSpacing: 100}}>
              <h6 style ={{height: 50}}>
                ...
                {"\t Account Role:"} {task.account_role}</h6>
                <h6 style ={{height: 50}}>
