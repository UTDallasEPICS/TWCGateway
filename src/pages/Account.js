...
// const emailFound = InfoFromAuth0APIReturn
...
const Account = () => {
  ...
  const fetchDB = async () => {
    const response = await fetch(
      "http://localhost:5001/displayEmployeedata/" + accountID
    );
      ...
      <Col>
        <Card>
          ...
          <CardBody>
            <Row>
              ...
              >
                ...
                <h5 style={{ height: 50 }}>
                  ...
                  {"\t Account Role:"} {task.account_role}
                </h5>
                <h5 style={{ height: 50 }}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <Row md={4}>
              <Col>
                <a href="/admin/Account/ChangePassword">Change Password</a>
              </Col>
              <Col>
                <a href="/admin/Account/EditInformation">Edit Information</a>
              </Col>
            </Row>
          </CardBody>
        </Card>
