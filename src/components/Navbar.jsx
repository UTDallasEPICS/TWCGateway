...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-light shadow-sm p-3 mb-1 bg-light rounded">
                ...
                <div style={{ flexDirection: "row", justifyContent: "flex-end"}} className="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="black" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
