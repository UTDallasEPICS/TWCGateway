import { Button, Nav, NavItem, CardTitle} from "reactstrap";
...
const SuperSidebar = () => {
  const showMobilemenu = () => {
    document.getElementById("supersidebarArea").classList.toggle("supershowSidebar");
  };
  let location = useLocation();

  return (
    <div className="p-3" >
      <div className="d-flex align-items-center" style ={{padding: "10px", alignSelf: "center", verticalAlign: "center"}}>
      <CardTitle tag="h3" >
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person-gear" viewBox="0 0 16 16">
        ...
        Supervisor Tools
      <hr style={{height: "5px", width: "200px"}}></hr>
      </CardTitle>
      <Button
          close
          size="sm"
